...
<html lang="en" ng-app="AngularSpringApp">
    ...
    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="#/address.html">
                                <i class="fa fa-th"></i> <span>ADDRESS</span> <small class="badge pull-right bg-green">new</small>
                            </a>
                        </li>
            ...
            <aside class="right-side">
                ...
                <section class="content">
                	...
                	CONTENIDO DE ANGULAR INDEX.HTML INICIO
					<div ng-view></div>
				    <!-- Main row -->
                    <!-- /.row (main row) -->
        ...
        <!-- FrondEnd and Application Angular Libraries -->
